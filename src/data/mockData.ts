...
export const userNeedsData = [
  { 
    ...
    platformComments: [
      { platform: '携程' as ReviewPlatform, content: '前台办理很快，礼宾还帮忙拿行李到房间', date: '2024-12-10', rating: 5, sentiment: 'positive' as const },
      { platform: '携程' as ReviewPlatform, content: '下午3点到的，前台只有一个人，排队等了25分钟', date: '2024-12-08', rating: 3, sentiment: 'negative' as const },
      { platform: '美团' as ReviewPlatform, content: '提前到店也给办了早入住，没有额外收费', date: '2024-12-09', rating: 5, sentiment: 'positive' as const },
      { platform: '美团' as ReviewPlatform, content: '周末入住高峰期等了很久，建议多开几个窗口', date: '2024-12-07', rating: 2, sentiment: 'negative' as const },
      { platform: '飞猪' as ReviewPlatform, content: '行李寄存很方便，礼宾服务不错', date: '2024-12-11', rating: 4, sentiment: 'positive' as const },
      { platform: 'Booking' as ReviewPlatform, content: 'Smooth check-in, staff remembered my name', date: '2024-12-10', rating: 5, sentiment: 'positive' as const },
      { platform: 'Expedia' as ReviewPlatform, content: 'Check-in took 20 minutes during peak hours', date: '2024-12-06', rating: 3, sentiment: 'negative' as const },
      { platform: 'Agoda' as ReviewPlatform, content: 'Express check-out was convenient', date: '2024-12-09', rating: 4, sentiment: 'positive' as const },
    ],
  },
  { 
    category: '舒适需求', 
    ...
    platformComments: [
      { platform: '携程' as ReviewPlatform, content: '床垫软硬适中，枕头有多种选择，睡眠质量很好', date: '2024-12-10', rating: 5, sentiment: 'positive' as const },
      { platform: '携程' as ReviewPlatform, content: '房间靠马路，外滩游客多，凌晨还能听到嘈杂声', date: '2024-12-09', rating: 2, sentiment: 'negative' as const },
      { platform: '美团' as ReviewPlatform, content: '浴室设计很棒，雨淋花洒水压足，浴缸也很大', date: '2024-12-08', rating: 5, sentiment: 'positive' as const },
      { platform: '美团' as ReviewPlatform, content: '空调出风口正对床头，晚上吹得头疼', date: '2024-12-07', rating: 2, sentiment: 'negative' as const },
      { platform: '飞猪' as ReviewPlatform, content: '房间安静，床品是高支棉的，很舒服', date: '2024-12-10', rating: 5, sentiment: 'positive' as const },
      { platform: 'Booking' as ReviewPlatform, content: 'Room was spacious with great Bund view, very quiet', date: '2024-12-09', rating: 5, sentiment: 'positive' as const },
      { platform: 'Expedia' as ReviewPlatform, content: 'Street noise was an issue even on high floor', date: '2024-12-08', rating: 3, sentiment: 'negative' as const },
      { platform: 'Agoda' as ReviewPlatform, content: 'Excellent bed quality, slept like a baby', date: '2024-12-07', rating: 5, sentiment: 'positive' as const },
    ],
  },
  { 
    category: '服务需求', 
    ...
    platformComments: [
      { platform: '携程' as ReviewPlatform, content: '前台小姐姐认出我是优悦会金卡，主动升了江景房', date: '2024-12-11', rating: 5, sentiment: 'positive' as const },
      { platform: '携程' as ReviewPlatform, content: '晚上10点要加床矿泉水，等了40分钟才送来', date: '2024-12-09', rating: 2, sentiment: 'negative' as const },
      { platform: '美团' as ReviewPlatform, content: '管家推荐了附近很棒的本地餐厅，邻里文化体验很好', date: '2024-12-10', rating: 5, sentiment: 'positive' as const },
      { platform: '美团' as ReviewPlatform, content: '问前台附近景点怎么走，回答很敷衍', date: '2024-12-08', rating: 3, sentiment: 'negative' as const },
      { platform: '飞猪' as ReviewPlatform, content: '礼宾帮忙订了外滩观光的好位置，很专业', date: '2024-12-09', rating: 5, sentiment: 'positive' as const },
      { platform: 'Booking' as ReviewPlatform, content: 'Concierge gave great local dining recommendations', date: '2024-12-08', rating: 5, sentiment: 'positive' as const },
      { platform: 'Expedia' as ReviewPlatform, content: 'Housekeeping forgot to replenish toiletries', date: '2024-12-07', rating: 3, sentiment: 'negative' as const },
      { platform: 'Agoda' as ReviewPlatform, content: 'Staff was warm and attentive throughout stay', date: '2024-12-10', rating: 5, sentiment: 'positive' as const },
    ],
  },
  { 
    category: '早餐需求', 
    ...
    platformComments: [
      { platform: '携程' as ReviewPlatform, content: '早餐融合了本地特色，有现做的小笼包和葱油拌面', date: '2024-12-11', rating: 5, sentiment: 'positive' as const },
      { platform: '携程' as ReviewPlatform, content: '周末早餐人太多，等了15分钟才有位置', date: '2024-12-09', rating: 3, sentiment: 'negative' as const },
      { platform: '美团' as ReviewPlatform, content: '餐厅能看到外滩，边吃早餐边看黄浦江，太惬意了', date: '2024-12-10', rating: 5, sentiment: 'positive' as const },
      { platform: '美团' as ReviewPlatform, content: '鸡蛋档口只有一个人，现做蛋卷等了很久', date: '2024-12-08', rating: 3, sentiment: 'negative' as const },
      { platform: '飞猪' as ReviewPlatform, content: '咖啡品质不错，果汁是鲜榨的', date: '2024-12-09', rating: 4, sentiment: 'positive' as const },
      { platform: 'Booking' as ReviewPlatform, content: 'Breakfast with Bund view was the highlight', date: '2024-12-10', rating: 5, sentiment: 'positive' as const },
      { platform: 'Expedia' as ReviewPlatform, content: 'Breakfast area was crowded on weekends', date: '2024-12-07', rating: 3, sentiment: 'neutral' as const },
      { platform: 'Agoda' as ReviewPlatform, content: 'Loved the local Shanghai dishes at breakfast', date: '2024-12-08', rating: 5, sentiment: 'positive' as const },
    ],
  },
  { 
    category: '性价比需求', 
    ...
    platformComments: [
      { platform: '携程' as ReviewPlatform, content: '优悦会白金卡直接升了带阳台的套房，太值了', date: '2024-12-11', rating: 5, sentiment: 'positive' as const },
      { platform: '携程' as ReviewPlatform, content: '外滩地段贵理解，但2000多的房间设施有点老旧', date: '2024-12-05', rating: 3, sentiment: 'negative' as const },
      { platform: '美团' as ReviewPlatform, content: '含双早的套餐比单订房+早餐划算很多', date: '2024-12-10', rating: 4, sentiment: 'positive' as const },
      { platform: '美团' as ReviewPlatform, content: '迷你吧一瓶可乐50块，太离谱了', date: '2024-12-06', rating: 2, sentiment: 'negative' as const },
      { platform: '飞猪' as ReviewPlatform, content: '双11活动价订的，性价比超高', date: '2024-12-09', rating: 5, sentiment: 'positive' as const },
      { platform: 'Booking' as ReviewPlatform, content: 'Worth the price for the location and experience', date: '2024-12-08', rating: 4, sentiment: 'positive' as const },
      { platform: 'Expedia' as ReviewPlatform, content: 'A bit overpriced compared to similar hotels nearby', date: '2024-12-07', rating: 3, sentiment: 'negative' as const },
      { platform: 'Agoda' as ReviewPlatform, content: 'Good deal with the member discount', date: '2024-12-10', rating: 4, sentiment: 'positive' as const },
    ],
  },
  { 
    category: '邻里文化', 
    ...
    platformComments: [
      { platform: '携程' as ReviewPlatform, content: '大堂融合了老上海风情和现代设计，一进门就被惊艳到', date: '2024-12-11', rating: 5, sentiment: 'positive' as const },
      { platform: '携程' as ReviewPlatform, content: '设计是好看，但为了设计感牺牲了房间空间', date: '2024-12-08', rating: 3, sentiment: 'negative' as const },
      { platform: '美团' as ReviewPlatform, content: '电梯间的外滩老照片很有历史感，每层楼设计都不同', date: '2024-12-10', rating: 5, sentiment: 'positive' as const },
      { platform: '美团' as ReviewPlatform, content: '想参加邻里文化活动但时间都在工作日白天', date: '2024-12-07', rating: 3, sentiment: 'negative' as const },
      { platform: '飞猪' as ReviewPlatform, content: '前台推荐的隐藏咖啡馆太惊喜了，真的很local', date: '2024-12-09', rating: 5, sentiment: 'positive' as const },
      { platform: 'Booking' as ReviewPlatform, content: 'The neighborhood walking tour organized by hotel was amazing', date: '2024-12-08', rating: 5, sentiment: 'positive' as const },
      { platform: 'Expedia' as ReviewPlatform, content: 'Beautiful design that captures Shanghai essence', date: '2024-12-10', rating: 5, sentiment: 'positive' as const },
      { platform: 'Agoda' as ReviewPlatform, content: 'Love how they incorporate local art and culture', date: '2024-12-09', rating: 5, sentiment: 'positive' as const },
    ],
  },
];
